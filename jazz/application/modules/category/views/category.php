	...
	<div class="col-xs-12">
		<div class="box">
			<div class="box-content">
				<div id="tabs">
					<ul>
						<li><a href="http://jazz.jabouzi.com#tabs-1">Android</a></li>
						<li><a href="http://jazz.jabouzi.com#tabs-2">Firefox OS</a></li>
						<li><a href="http://jazz.jabouzi.com#tabs-3">Linux</a></li>
					</ul>
					<div id="tabs-1">
						<p>
