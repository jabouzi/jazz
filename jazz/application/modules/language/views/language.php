					...
					<tbody>
						<?php foreach ($languages->result() as $language) : ?>
							<tr>
								...
								<td><label><input type="radio" name="language_default" value="<?php echo $language->language_id; ?>" <?php if (ord($language->language_default)) echo 'checked'; ?> ><i class="fa fa-circle-o"></i></label></td>
								<td>
