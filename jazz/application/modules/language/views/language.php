					...
					<tbody>
						<?php foreach ($languages->result() as $language) : ?>
							<tr>
								...
								<td class="radio"><input type="radio" name="language_default" value="<?php echo $language->language_id; ?>" <?php if (ord($language->language_default)) echo 'checked'; ?> >&nbsp;<i class="fa fa-circle-o"></i></td>
								<td>
