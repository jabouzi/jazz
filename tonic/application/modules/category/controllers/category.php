...
class Category extends MX_Controller
{
	...
	private function generate_categories_tree($categories, $parent = 0, $depth = 0)
	{
		...
		foreach($categories as $category)
		{
			if($category->category_parent_id == $parent)
			{
				...
				$tree[$category->category_id] = $category->category_id;
				$tree[0] = $this->generate_categories_tree($categories, $category->category_id, $depth+1);
			}
		}
	...
	private function get_categories_structure()
	{
		...
		$order_by = 'tonic_categories.category_id ASC, tonic_categories.category_parent_id ASC, tonic_categories.category_order ASC';
