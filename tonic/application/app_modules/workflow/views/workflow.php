		...
		<div class="module_content" id="workflow_list">
			...
			<?php foreach ($workflows as $id => $workflow) : ?>
				<fieldset>
					...
					<input style="width:15%; padding-left: 0;" type="text" id="order[<?php echo $id; ?>]" name="order[<?php echo $id; ?>]" value="<?php echo $workflow['order']; ?>" data-validate="required" data-type="text" data-pos="1" title="<?php echo lang('workflow.order'); ?>">
